...
<div class="container">
    ...
    <nav class="navbar navbar-expand  navbar-light bg-info">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!-- Filtrado de Usuarios rol administrador-->
                @if(Auth::user()->role_id == 1)
                <li class="nav-item active">
                    <a class="nav-link "  href="{{route('home')}}"><div class="text-color">
                            Inicio
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('usuario.index')}}"><div class="text-color">Usuarios</div></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('deficiencia.index')}}">
                        <div class="text-color">
                            Deficiencias/Medidas
                        </div>
                    </a>
                </li>
                    <!--  FIN Filtrado de Usuarios rol administrador-->
                    @endif
            <!-- Filtrado de Usuarios no admin rol-->
                @if(Auth::user()->role_id > 1)
                <li class="nav-item active">
                ...
                <li class="nav-item active">
                   <a class="nav-link "  href="{{route('sistema.index')}}">
                       <div class="text-color">Plan/Medidas
                       </div>
                       <span class="sr-only">(current)
                       </span>
                   </a>
            ...
            <form class="form-inline my-2 my-lg-0" action="{{route('sistema.index')}}" method="get">
